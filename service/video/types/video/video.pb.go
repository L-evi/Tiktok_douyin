...
type FavoriteListResp struct {
	...
	Resp      *Resp    `protobuf:"bytes,1,opt,name=resp,proto3" json:"resp,omitempty"`
	VideoList []*Video `protobuf:"bytes,2,rep,name=video_list,json=videoList,proto3" json:"video_list,omitempty"` // 视频id列表
}
...
var file_video_proto_rawDesc = []byte{
	...
	0x69, 0x73, 0x74, 0x22, 0xeb, 0x01, 0x0a, 0x05, 0x56, 0x69, 0x64, 0x65, 0x6f, 0x12, 0x0e, 0x0a,
	...
	0x6c, 0x6c, 0x6f, 0x77, 0x22, 0x6d, 0x0a, 0x07, 0x43, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x12,
	...
	0x61, 0x74, 0x65, 0x22, 0x90, 0x01, 0x0a, 0x10, 0x63, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x41,
	...
	0x6e, 0x74, 0x5f, 0x69, 0x64, 0x18, 0x04, 0x20, 0x01, 0x28, 0x03, 0x52, 0x09, 0x63, 0x6f, 0x6d,
	0x6d, 0x65, 0x6e, 0x74, 0x49, 0x64, 0x22, 0x5e, 0x0a, 0x11, 0x63, 0x6f, 0x6d, 0x6d, 0x65, 0x6e,
	...
	0x6e, 0x74, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0e, 0x2e,
	...
	0x52, 0x0c, 0x63, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x32, 0xc8,
	0x03, 0x0a, 0x05, 0x76, 0x69, 0x64, 0x65, 0x6f, 0x12, 0x30, 0x0a, 0x07, 0x70, 0x75, 0x62, 0x6c,
	...
	0x75, 0x62, 0x6c, 0x69, 0x73, 0x68, 0x52, 0x65, 0x73, 0x70, 0x12, 0x42, 0x0a, 0x0d, 0x63, 0x6f,
	...
	0x43, 0x6f, 0x75, 0x6e, 0x74, 0x52, 0x65, 0x73, 0x70, 0x42, 0x09, 0x5a, 0x07, 0x2e, 0x2f, 0x76,
...
var file_video_proto_depIdxs = []int32{
	...
	0,  // 3: video.commentActionResp.resp:type_name -> video.Resp
	9,  // 4: video.commentActionResp.comment:type_name -> video.Comment
	0,  // 5: video.commentListResp.resp:type_name -> video.Resp
	9,  // 6: video.commentListResp.comment_list:type_name -> video.Comment
	0,  // 7: video.favoriteCountResp.resp:type_name -> video.Resp
	0,  // 8: video.commentCountResp.resp:type_name -> video.Resp
	1,  // 9: video.video.publish:input_type -> video.publishReq
	10, // 10: video.video.commentAction:input_type -> video.commentActionReq
	12, // 11: video.video.commentList:input_type -> video.commentListReq
	3,  // 12: video.video.favoriteAction:input_type -> video.favoriteActionReq
	5,  // 13: video.video.favoriteList:input_type -> video.favoriteListReq
	14, // 14: video.video.favoriteCount:input_type -> video.favoriteCountReq
	16, // 15: video.video.commentCount:input_type -> video.commentCountReq
	2,  // 16: video.video.publish:output_type -> video.publishResp
	11, // 17: video.video.commentAction:output_type -> video.commentActionResp
	13, // 18: video.video.commentList:output_type -> video.commentListResp
	4,  // 19: video.video.favoriteAction:output_type -> video.favoriteActionResp
	6,  // 20: video.video.favoriteList:output_type -> video.favoriteListResp
	15, // 21: video.video.favoriteCount:output_type -> video.favoriteCountResp
	17, // 22: video.video.commentCount:output_type -> video.commentCountResp
